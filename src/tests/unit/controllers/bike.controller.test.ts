...
describe('Bike controller', () => {
  ...
  it('should get all bikes', async () => {
    ...
    expect(res.json).toHaveBeenCalledWith(
      expect.arrayContaining([
        expect.objectContaining({ id: '9c3c44c5-313a-4e04-9636-89aca282b1aa' })
      ])
    );
  });
  ...
  it('should create a bike', async () => {
    ...
    expect(res.json).toHaveBeenCalledWith(
      expect.objectContaining({ marca: 'Caloi' })
    );
  });
  ...
  it('should create rel bike lock', async () => {
    ...
    expect(res.json).toHaveBeenCalledWith(
      expect.objectContaining({ id: '9c3c44c5-313a-4e04-9636-89aca282b1a3' })
    );
  });
  ...
  it('should delete rel bike lock', async () => {
    ...
    expect(res.json).toHaveBeenCalledWith(
      expect.objectContaining({ id: '9c3c44c5-313a-4e04-9636-89aca282b1a2' })
    );
  });
});
